...
export interface DeployDestinationSettlerInterface extends utils.Interface {
  functions: {
...
export interface DeployDestinationSettler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: DeployDestinationSettlerInterface
