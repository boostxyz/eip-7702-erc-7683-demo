...
export interface DeployOriginSettlerInterface extends utils.Interface {
  functions: {
...
export interface DeployOriginSettler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: DeployOriginSettlerInterface
