...
export interface Vm extends BaseContract {
  ...
  functions: {
    ...
    assume(condition: boolean, overrides?: CallOverrides): Promise<[undefined]>

    assumeNoRevert(overrides?: CallOverrides): Promise<[undefined]>
    ...
    pauseTracing(overrides?: CallOverrides): Promise<[undefined]>
    ...
    projectRoot(overrides?: CallOverrides): Promise<[string] & { path: string }>
    ...
    resumeTracing(overrides?: CallOverrides): Promise<[undefined]>
  ...
  callStatic: {
    ...
    getBroadcast(
      ...
      txType: BigNumberish,
      overrides?: CallOverrides,
    ): Promise<VmSafe.BroadcastTxSummaryStructOutput>
  ...
  estimateGas: {
    ...
    'broadcast()'(overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    randomAddress(overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    snapshotState(overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    stopBroadcast(overrides?: Overrides & { from?: string }): Promise<BigNumber>
